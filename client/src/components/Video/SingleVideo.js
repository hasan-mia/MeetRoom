    ...
    return (
        <div className='w-full mx-auto'>
            ...
            <div className='rounded-xl border border-green-500 relative gap-2 mt-2 h-fit'>
                ...
                {/* =======Video Player======= */}
                    <div className="grid grid-cols-1 gap-2 justify-center rounded-xl p-2 relative" ref={containerVideo} style={{height: `${partnerVideo?.current?.clientWidth - partnerVideo?.current?.clientWidth * 23 / 100}px`}}>
