                ...
                <div className="text-center text-gray-200">
                    <div className="flex flex-col gap-2 items-center">
                        <div className="w-12/12">
                            <h1 className="lg:text-4xl text-2xl font-semibold">Notify Your Users</h1>
             ...
             <div className="md:w-12/12 lg:w-6/12">
                <div className='mt-4'>
                    <div className='flex flex-col gap-4'>
                        <textarea type="text" className="textarea textarea-bordered" placeholder="Type your messege" rows={5}></textarea>
                        <button  type="button" className='btn bg-green-600 rounded-md' >Send Notification</button>
                    </div>
                </div>
            </div>
        </>
