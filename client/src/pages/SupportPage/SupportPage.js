			...
			<div className="my-2 lg:my-4 text-gray-600">
				<div className="text-center px-4">
					<h2 className="text-3xl leading-normal font-bold text-gray-600 dark:text-gray-200">
						...
						<span className="border-b">We Best!</span>
					</h2>
				</div>
				<div className="flex flex-col-reverse lg:flex-row items-center mt-4">
					<div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 md:px-6">
						<div className="flex mb-12 border-b-2 pb-2">
							...
							<div className="grow mx-4">
								<p className="font-semibold uppercase mb-1 text-lg">
									Support 24/7
								</p>
					...
					<div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 mb-4 lg:mb-0 md:px-6 mt-2 lg:mt-0">
						<div
							className="relative overflow-hidden bg-no-repeat bg-cover rounded-lg shadow-lg"
							data-mdb-ripple="true"
							data-mdb-ripple-color="light"
						>
							<img src={support} className="w-full rounded-xl" alt="support" />
						</div>
					</div>
				</div>
			</div>
